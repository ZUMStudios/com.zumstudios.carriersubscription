namespace com.zumstudios.carriersubscription
{
    public static class CarrierSubscriptionConstants
    {
        ...
        public const string KLIENTO_DEFAULT_URL =
            "https://kliento.dv-content.io/19408/login/all?identifier={PHONE_NUMBER}&atom_service_id={ATOM_SERVICE_ID}";
        public const string KLIENTO_VALIDATOR_URL =
            "https://kliento.dv-content.io/19408/login/all?identifier={PHONE_NUMBER}&validator={VALIDATOR}&atom_service_id={ATOM_SERVICE_ID}";
